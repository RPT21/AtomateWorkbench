...
# Embedded file name: ../plugins/et2216e/src/et2216e/userinterface/initdialog.py
...
class ShutdownInitializeDialog(plugins.poi.poi.dialogs.Dialog):
    ...
    def createControl(self, parent):
        ...
        # wx.EXPAND overrides alignment in BoxSizer; remove ALIGN_CENTRE_VERTICAL
        sizer.Add(messageImageGroup, 1, wx.EXPAND | wx.ALL, 5)
    ...
    def createMessageImageGroup(self, composite):
        ...
        # Avoid combining wx.EXPAND and alignment flags
        sizer.Add(self.messageLabel, 1, wx.EXPAND | wx.ALL, 10)
