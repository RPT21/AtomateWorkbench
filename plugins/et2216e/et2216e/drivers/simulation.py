...
class SimConfigurationSegment(object):
    ...
    def createControl(self, composite):
        ...
        label.Enable(False)
        sizer.Add(label, 1, wx.GROW | wx.ALL, 5)
...
class ShowPanelAction(poi.actions.Action):
    ...
    def __init__(self, driver):
        poi.actions.Action.__init__(self, 'Eurotherm 2200 Series Sim Panel %s' % driver.hwinst.getDescription().getName(), '', '')
        self.driver = driver
...
class SimulationDeviceDriver(et2216e.drivers.DeviceDriver):
    __module__ = __name__
    ...
    def createDialog(self):
        ...
        s.Add(tempSlider, 1, wx.GROW | wx.ALIGN_CENTRE_VERTICAL)
        sizer.Add(s, 0, wx.GROW | wx.ALL, 5)
        sizer.Add(self.lockoutPanel, 0, wx.GROW | wx.ALL, 5)
        s = wx.BoxSizer(wx.HORIZONTAL)
    ...
    def getID(self):
        return 'Eurotherm 2200 Simulation Driver'
...
et2216e.drivers.registerDriver('simulation', SimulationDeviceDriver, SimConfigurationSegment, 'Simulation')
