...
# Embedded file name: ../plugins/et2216e/src/et2216e/et2216enode.py
# Compiled at: 2004-11-19 02:19:39
import rs485
...
DICTIONARY_ET2216E = {'hours.minutes': ('WWRD0307 01 ', '0'), 'minutes.seconds': ('WWRD0307 01 ', '0'), 'panel lockout': ('WWRD0118 01 ', '2'), 'panel unlock': ('WWRD0118 01 ', '0'), 'reset': ('WWRD0121 01 ', '0'), 'run': ('WWRD0121 01 ', '1'), 'local': ('WWRD0121 01 ', '2'), 'setpoint': ('WWRD0114 01 ', ''), 'min temp': ('WWRD0306 01 ', ''), 'max temp': ('WWRD0305 01 ', ''), 'start temp': ('WWRD0228 01 ', ''), 'autotune on': ('WWRD0263 01 ', '1'), 'autotune off': ('WWRD0263 01 ', '0'), 'current setpoint': ('WRDD0010 01', ''), 'current temp': ('WRDD0002 01', ''), 'set pid': (['WRW03D0105 ', ' D0106 ', ' D0107 '], ['', '', '']), 'get pid': (['WRR03D0105 ', 'D0106 ', 'D0107'], ['', '', ''])}
...
class et2216eDeviceNode(rs485.RS485SerialNetworkNode):
    __module__ = __name__
    ...
    def initialize(self):
        if self.configuration is None:
            raise Exception('et2216e [address: %s] is not configured' % self.address)
