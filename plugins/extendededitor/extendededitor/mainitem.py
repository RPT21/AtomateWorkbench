...
class MainEditorItem(extendededitor.item.ExtendedEditorItem):
    ...
    def createBody(self, parent):
        ...
        sizer.Add(fsizer, 0, wx.GROW | wx.ALL, 0)
        ...
        sizer.Add(fsizer, 0, wx.GROW | wx.LEFT, 15)
        self.conditionalList = self.createConditionalList(self.body)
        sizer.Add(self.conditionalList.getControl(), 0, wx.GROW | wx.TOP | wx.BOTTOM, 5)
