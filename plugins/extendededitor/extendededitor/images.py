...
# Embedded file name: ../plugins/extendededitor/src/extendededitor/images.py
...
imagesFilenames = {MAIN_ITEM: (os.path.join(TOOLS_DIR_PREFIX, 'main_item.gif')), VIEW_ICON: (os.path.join(ENABLED_DIR_PREFIX, 'ee_icon.gif'))}
