...
class TestEditor(object):
    ...
    def createControl(self, parent):
        ...
        hsizer.Add(self.testNameField, 1, wx.EXPAND)
        ...
        # wx.EXPAND overrides alignment; remove ALIGN_LEFT
        sizer.Add(hsizer, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT, 10)
        ...
        # wx.EXPAND overrides alignment; remove ALIGN_LEFT
        sizer.Add(hsizer, 0, wx.EXPAND | wx.LEFT | wx.BOTTOM, 10)
