...
import wx, ConfigParser, core.preferencesstore, ui.preferences, kernel.plugin, kernel.pluginmanager as PluginManager, logging, validator.messages as messages, validator.userinterface.preferences, validator.agent
...
class ValidatorPlugin(kernel.plugin.Plugin):
    __module__ = __name__
    ...
    def startup(self, contextBundle):
        ...
        self.validatoragent = validator.agent.ValidatorAgent()
    ...
    def setupPreferencesStore(self):
        ...
        ui.preferences.getDefault().addPage(validator.userinterface.preferences.PreferencesPage(preferencesStore))
