...
import copy, os, sys, kernel, string, ConfigParser, hardware, logging, poi.actions, ui
...
def getHardwareConfigPath():
    ...
    path = os.path.join(kernel.getPluginWorkspacePath(hardware.PLUGIN_ID), HARDWARE_CONFIG_DIRNAME)
