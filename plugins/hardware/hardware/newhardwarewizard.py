...
class LabelProvider(plugins.poi.poi.views.contentprovider.LabelProvider):
    __module__ = __name__
...
class NameHardwarePage(plugins.poi.poi.wizards.WizardPage):
    __module__ = __name__

    def __init__(self):
        plugins.poi.poi.wizards.WizardPage.__init__(self, 'name', 'Hardware Name')
...
class HardwareTypeSelectionPage(plugins.poi.poi.wizards.WizardPage):
    __module__ = __name__

    def __init__(self):
        plugins.poi.poi.wizards.WizardPage.__init__(self, 'typeselection', 'Hardware Selection')
    ...
    def performFinish(self):
        ...
        try:
            hw = plugins.hardware.hardware.hardwaremanager.create(name, hardwareType)
