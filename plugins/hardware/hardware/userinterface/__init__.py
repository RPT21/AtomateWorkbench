...
class HardwareTypesLabelProvider(contentprovider.LabelProvider):
    __module__ = __name__

    def __init__(self):
        contentprovider.LabelProvider.__init__(self)
...
class HardwareTypesContentProvider(contentprovider.ContentProvider):
    __module__ = __name__

    def __init__(self):
        contentprovider.ContentProvider.__init__(self)
        self.tinput = None
        return
