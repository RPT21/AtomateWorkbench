...
class NetworkConfigurationSegment(object):
    ...
    def createControl(self, composite):
        ...
        sizer.Add(hostLabel, 0, wx.GROW | wx.ALIGN_CENTRE_VERTICAL)
        sizer.Add(self.hostField, 1, wx.GROW | wx.ALIGN_CENTRE_VERTICAL)
        sizer.Add(portLabel, 0, wx.GROW | wx.ALIGN_CENTRE_VERTICAL)
        sizer.Add(self.portField, 1, wx.GROW | wx.ALIGN_CENTRE_VERTICAL)
