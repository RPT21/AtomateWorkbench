...
# Embedded file name: ../plugins/mks647bc/src/mks647bc/userinterface/initdialog.py
...
class ShutdownInitializeDialog(poi.dialogs.Dialog):
    ...
    def createControl(self, parent):
        ...
        sizer.Add(messageImageGroup, 1, wx.GROW | wx.ALIGN_CENTRE_VERTICAL | wx.ALL, 5)
    ...
    def createMessageImageGroup(self, composite):
        ...
        sizer.Add(self.messageLabel, 1, wx.GROW | wx.ALL | wx.ALIGN_CENTRE_VERTICAL, 10)
