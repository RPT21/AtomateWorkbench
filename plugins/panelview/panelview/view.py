...
import wx, copy, poi.views, logging, threading, panelview.devicemediator, panelview.images as images, panelview.messages as messages, panelview.item
...
class ViewerView(object):
    ...
    def dispose(self):
        ...
        panelview.devicemediator.removeView(self)
