...
DICTIONARY_UP150 = {'hours.minutes': ('WWRD0307 01 ', '0'), 'minutes.seconds': ('WWRD0307 01 ', '0'),
                    ...
                    'start temp': ('WWRD0228 01 ', ''), 'autotune on': ('WWRD0263 01 ', '1'), 'autotune off': ('WWRD0263 01 ', '0'),
                    'current setpoint': ('WRDD0010 01', ''), 'current temp': ('WRDD0002 01', ''),
                    'set pid': (['WRW03D0105 ', ' D0106 ', ' D0107 '], ['', '', '']),
