...
class SimulationDeviceDriver(mkspdr2000.drivers.DeviceDriver):
    ...
    def createDialog(self):
        ...
        vsizer.Add(self.gaugeCtrl1, 1, wx.GROW | wx.ALL, 5)
        vsizer.Add(self.low1, 0, wx.GROW | wx.ALL, 5)
        vsizer.Add(self.off1, 0, wx.GROW | wx.ALL, 5)
        mainsizer.Add(vsizer, 0, wx.GROW | wx.ALL, 10)
        vsizer = wx.BoxSizer(wx.VERTICAL)
        ...
        vsizer.Add(self.gaugeCtrl2, 1, wx.GROW | wx.ALL, 5)
        vsizer.Add(self.low2, 0, wx.GROW | wx.ALL, 5)
        vsizer.Add(self.off2, 0, wx.GROW | wx.ALL, 5)
        mainsizer.Add(vsizer, 0, wx.GROW | wx.ALL, 10)
