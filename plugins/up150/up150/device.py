...
import traceback, wx, plugins.up150.up150.stepentry as up150_stepentry
...
class UP150DeviceEditor(core.device.DeviceEditor):
    ...
    def selectHardware(self, hwid):
        ...
        if description is None:
            logger = __import__('logging').getLogger('up150.device')
...
class UP150Device(core.device.Device):
    ...
    def parseFromNode(self, node):
        return up150_stepentry.parseFromNode(node)
    ...
    def createNewStepEntry(self, fromExisting=None):
        ...
        return up150_stepentry.UP150StepEntry()
