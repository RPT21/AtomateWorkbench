...
import wx, ui, executionengine.purgemanager, poi.actions, wx.lib.mixins.listctrl as listmix, wx.lib.buttons as buttons
...
class PurgeManagerViewer(object):
    ...
    def populateList(self):
        workers = executionengine.purgemanager.getPurgeWorkers()
...
class ShowPurgeManagerViewerWindowAction(poi.actions.Action):
    __module__ = __name__

    def __init__(self, owner):
        poi.actions.Action.__init__(self, 'Purge Manager')
        self.owner = owner
