...
import wx, os, sys, string, ConfigParser, logging, kernel, poi.dialogs, poi.views, ui.messages as messages, ui.images as images, ui.preferences
DIALOG_PREFS_FILE = 'prefsdialog.prefs'
logger = logging.getLogger('ui.preferences')

class PreferencesDialog(poi.dialogs.Dialog):
    __module__ = __name__
