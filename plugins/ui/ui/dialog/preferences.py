...
class PreferencesDialog(poi_dialogs.Dialog):
    ...
    def createControl(self, parent):
        ...
        bodysizer.Add(self.tree, 0, wx.EXPAND | wx.RIGHT, 5)
        bodysizer.Add(self.body, 1, wx.EXPAND)
        ...
        mainsizer.Add(bodysizer, 1, wx.EXPAND | wx.ALL, 5)
        mainsizer.Add(wx.StaticLine(self.control, -1), 0, wx.EXPAND)
    ...
    def createBody(self):
        ...
        sizer.Add(banner, 0, wx.EXPAND | wx.BOTTOM, 10)
        sizer.Add(self.stage, 1, wx.EXPAND)
        body.SetSizer(sizer)
    ...
    def setCurrentPage(self, page):
        ...
        try:
            ...
            page.handleShowing()
            sizer = self.stage.GetSizer()
            sizer.Add(control, 1, wx.EXPAND | wx.ALL)
            sizer.Layout()
