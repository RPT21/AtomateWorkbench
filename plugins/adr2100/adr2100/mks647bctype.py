...
import plugins.mks647bc.mks647bc.userinterface
...
class MKS647HardwareType(hardware.hardwaretype.HardwareType):
    ...
    def getConfigurationPage(self):
        return mks647bc.userinterface.ConfigurationPage()

    def getDeviceHardwareEditor(self):
        return mks647bc.userinterface.DeviceHardwareEditor()

    def getDescription(self):
        return 'MKS647BC Mass Flow Controller Thinger'
