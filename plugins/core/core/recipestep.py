...
import plugins.core.core.conditional, plugins.core.core.stepentry, plugins.core.core.recipe, logging
...
def fromNode(node, recipe):
    ...
    if conditionals != None:
        for conditionalNode in conditionals.getChildren('conditional'):
            try:
                conditional = plugins.core.core.conditional.parseFromNode(conditionalNode, recipe)
