...
class ProgressDialog(Dialog):
    ...
    def createControl(self, parent):
        ...
        sizer.Add(msgp, 0, wx.EXPAND | wx.ALL, 10)
        sizer.Add(prgp, 0, wx.EXPAND | wx.ALL, 10)
...
class MessageHeaderDialog(Dialog):
    ...
    def createHeader(self):
        ...
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(self.messageLabel, 0, wx.EXPAND | wx.LEFT | wx.TOP | wx.BOTTOM, 10)
        sizer.Add(self.descriptionLabel, 0, wx.EXPAND | wx.LEFT, 15)
        ...
        sizer.Add(hsizer, 0, wx.EXPAND | wx.LEFT | wx.BOTTOM, 5)
        bsizer = wx.BoxSizer(wx.HORIZONTAL)
        bsizer.Add(sizer, 1, wx.EXPAND | wx.ALL, 0)
...
class ExceptionDialog(wx.Dialog):
    ...
    def __init__(self, parent, exception, title=None):
        ...
        s.Add(self.valueLabel, 1, wx.EXPAND | wx.ALL, 0)
        vp.SetSizer(s)
        ...
        if bmp is not None:
            ...
            vsizer.Add(errorLabel, 0, wx.EXPAND)
            vsizer.Add(vp, 1, wx.EXPAND | wx.LEFT, 10)
            hsizer.Add(vsizer, 1, wx.EXPAND | wx.ALL)
            sizer.Add(hsizer, 1, wx.EXPAND | wx.ALL, 5)
        else:
            sizer.Add(errorLabel, 0, wx.EXPAND | wx.LEFT | wx.TOP | wx.BOTTOM, 5)
            sizer.Add(vp, 1, wx.EXPAND | wx.LEFT, 10)
...
class MessageDialog(wx.Dialog):
    ...
    def createMessageIcon(self, sizer, style, message):
        ...
        hsizer.Add(msg, 1, wx.ALIGN_TOP | wx.EXPAND)
        sizer.Add(hsizer, 1, wx.EXPAND | wx.ALL, 5)
        return
