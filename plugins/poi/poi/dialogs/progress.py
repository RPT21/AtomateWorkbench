...
"""
import gc, sys, wx, traceback, threading, poi.dialogs, poi.operation, time, logging
...
class ProgressDialog(poi.dialogs.Dialog, poi.operation.ProgressMonitor, wx.EvtHandler):
    __module__ = __name__

    def __init__(self, parent):
        wx.EvtHandler.__init__(self)
        poi.dialogs.Dialog.__init__(self)
        poi.operation.ProgressMonitor.__init__(self)
        self.created = False
        self.parent = parent
        self.canceled = False
