...
import wx, socket, time, threading, select, rs485.drivers, logging, serial
...
class SerialNetworkDriver(rs485.drivers.DeviceDriver):
    __module__ = __name__
    ...
    def setConfiguration(self, configuration):
        ...
        rs485.drivers.DeviceDriver.setConfiguration(self, configuration)
        try:
    ...
    def shutdown(self):
        ...
        if not self.status == rs485.drivers.STATUS_INITIALIZED:
...
rs485.drivers.registerDriver('serial', SerialNetworkDriver, SerialConfigurationSegment, 'Serial')
