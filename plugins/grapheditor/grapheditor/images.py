...
imagesFilenames = {ZOOM_SMALL: (os.path.join(TOOLS_DIR_PREFIX, 'small_zoom.png')),
                   ZOOM_LARGE: (os.path.join(TOOLS_DIR_PREFIX, 'large_zoom.png')),
                   RESIZE_WE: (os.path.join(TOOLS_DIR_PREFIX, 'resize_we.png')),
                   VIEW_ICON: (os.path.join(ENABLED_DIR_PREFIX, 'grapheditor_icon.gif'))}
