...
class FirstRecipeWizardPage(WizardPage):
    ...
    def createControl(self, composite):
        ...
        fsizer.Add(self.nameField, 1, wx.ALIGN_CENTRE_VERTICAL)
        ...
        sizer2.Add(label, 0, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
        sizer2.Add(self.commentCtrl, 0, wx.EXPAND | wx.ALL, 5)
        ...
        mainsizer.Add(fsizer, 0, wx.EXPAND | wx.ALL, 5)
        mainsizer.Add(sizer2, 0, wx.EXPAND)
        mainsizer.Add(self.sharedCheck, 0, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
        mainsizer.Add(self.createDefaultDevicesCheck, 0, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
