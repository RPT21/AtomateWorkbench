...
import wx, ui, logging, core.utils, poi.views, poi.dialogs, hardware.userinterface.configurator, hardware.hardwaremanager, rs485.drivers, rs485.userinterface.initdialog, threading, poi.operation, poi.dialogs.progress
SCCM = 'sccm'
SLM = 'slm'
SCMM = 'scmm'
SCFH = 'scfh'
...
class ConfigurationPage(hardware.userinterface.configurator.ConfigurationPage):
    ...
    def createConfigPanel(self, parent):
        ...
        mainsizer.Add(banner, 0, wx.GROW | wx.ALL, 5)
