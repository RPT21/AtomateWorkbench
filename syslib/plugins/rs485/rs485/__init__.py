...
import logging, kernel.plugin, kernel.pluginmanager as PluginManager, hardware.hardwaremanager, rs485.rs485type, rs485.drivers, rs485.drivers.ser, poi.actions, ui, threading, executionengine
instance = None
...
class RS485Plugin(kernel.plugin.Plugin):
    __module__ = __name__
    ...
    def startup(self, contextBundle):
        ...
        hwType = rs485type.RS485HardwareType()
    ...
    def beginInstantiation(self, descriptions):
        for description in descriptions:
            ...
            class InstancingThread(threading.Thread):
                ...
                def run(innerself):
                    hardware = RS485Hardware(description)
                    initialize = False
                    try:
