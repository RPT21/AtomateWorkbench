...
import wx, os, sys, ui.context, ui, kernel, core.recipe, poi.dialogs, poi.views, grideditor.adddevicedialog, grideditor.messages as messages
...
class DeviceEditorDialog(poi.dialogs.MessageHeaderDialog):
    ...
    def createBody(self, parent):
        ...
        sizer.Add(self.editor.getControl(), 1, wx.GROW | wx.ALL, 5)
        sizer.Add(wx.StaticLine(self.body, -1), 0, wx.GROW | wx.ALL, 5)
...
class RecipeOptionsDialog(poi.dialogs.MessageHeaderDialog):
    ...
    def createBody(self, parent):
        ...
        hsizer.Add(self.listctrl, 1, wx.GROW | wx.ALL, 5)
        hsizer.Add(self.actionsButtonSizer, 0, wx.ALIGN_TOP | wx.ALL, 5)
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(hsizer, 1, wx.GROW)
        sizer.Add(wx.StaticLine(self.stage, -1), 0, wx.GROW | wx.ALL, 5)
    ...
    def createActionButtons(self):
        ...
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(self.addButton, 0, wx.GROW)
        sizer.Add(self.removeButton, 0, wx.GROW | wx.TOP | wx.BOTTOM, 5)
        sizer.Add(self.editButton, 0, wx.GROW | wx.TOP, 10)
    ...
    def OnAddButton(self, event):
        dlg = grideditor.adddevicedialog.AddDeviceDialog()
