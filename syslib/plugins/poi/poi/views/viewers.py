...
class TableViewer(StructuredViewer):
    ...
    def createControl(self, parent):
        ...
        wx.EVT_LIST_ITEM_SELECTED(self.control, wid, self.OnItemSelected)
        wx.EVT_LIST_ITEM_DESELECTED(self.control, wid, self.OnItemDeselected)
        wx.EVT_LIST_ITEM_ACTIVATED(self.control, wid, self.OnItemActivated)
        wx.EVT_LIST_ITEM_FOCUSED(self.control, wid, self.OnItemFocused)
        wx.EVT_LIST_ITEM_RIGHT_CLICK(self.control, wid, self.OnItemRightClick)
        wx.EVT_LIST_KEY_DOWN(self.control, wid, self.OnKeyDown)
