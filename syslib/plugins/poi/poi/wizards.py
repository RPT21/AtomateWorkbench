...
class Wizard(poi.dialogs.MessageHeaderDialog):
    __module__ = __name__
    ...
    def __init__(self):
        ...
        poi.dialogs.MessageHeaderDialog.__init__(self)
        return
    ...
    def showPage(self, page):
        ...
        self.contentSizer.Add(page.getControl(), 1, wx.GROW | wx.ALL, 0)
    ...
    def createButtons(self, parent):
        ...
        wx.EVT_BUTTON(parent, buttonFinish.GetId(), self.OnClickFinish)
        wx.EVT_BUTTON(parent, buttonNext.GetId(), self.OnClickNext)
        wx.EVT_BUTTON(parent, buttonBack.GetId(), self.OnClickBack)
        wx.EVT_BUTTON(parent, buttonCancel.GetId(), self.OnClickCancel)
    ...
    def createContent(self, composite):
        ...
        sizer.Add(self.content, 1, wx.GROW | wx.ALL, 0)
        sizer.Add(wx.StaticLine(panel, -1, style=wx.LI_HORIZONTAL), 0, wx.GROW | wx.ALL, 0)
        sizer.Add(buttons, 0, wx.ALIGN_RIGHT | wx.ALL, 5)
        panel.SetSizer(sizer)
        panel.SetAutoLayout(True)
        sizer = wx.BoxSizer(wx.VERTICAL)
        sizer.Add(panel, 1, wx.GROW | wx.ALL, 0)
        sizer.Fit(composite)
