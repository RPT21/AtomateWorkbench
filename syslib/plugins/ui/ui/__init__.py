...
import kernel, logging, kernel.plugin, kernel.boot, kernel.splash, poi, poi.actions.menumanager, poi.actions.statusbarmanager, poi.actions.toolbarmanager, ui.messages as messages, ui.images as images, ui.actions, ui.mainframe, ui.preferences, ui.undomanager, ui.context, ui.splash, threading, wx, copy, ConfigParser, os, sys, traceback
MB_FILE = 'atm.file'
MB_EDIT = 'atm.edit'
MB_HELP = 'atm.help'
MB_TOOLS = 'atm.tools'
...
class UIPlugin(kernel.plugin.Plugin):
    __module__ = __name__
    ...
    def startup(self, contextBundle):
        ...
        kernel.splash.increment('Loading User Interface ...')
        kernel.boot.addBootSequenceListener(self)
        self.createApp()
    ...
    def bringUpSplash(self):
        self.splash = ui.splash.SplashPage(None)
        self.splash.show()
    ...
    def bootSequenceComplete(self):
        kernel.boot.removeBootSequenceListener(self)
        self.createUI()
        self.restoreLayout()
        self.mainFrame.show()
        self.firePartInit()
    ...
    def createUI(self):
        ...
        mm = poi.actions.menumanager.MenuManager(None, '#MENUBAR')
        ...
        self.menuManager = mm
        self.mainFrame = ui.mainframe.MainFrame()
    ...
    def createFileMenuManager(self):
        global MB_FILE
        fileManager = poi.actions.menumanager.MenuManager(messages.get('mainmenu.file'), MB_FILE)
        ...
        exitAction = ui.actions.ExitAction()
    ...
    def createEditMenuManager(self):
        ...
        mng.addItem(poi.actions.ActionContributionItem(ui.undomanager.REDO_ACTION))
    ...
    def createToolsMenuManager(self):
        ...
        mng.addItem(poi.actions.ActionContributionItem(ui.actions.PreferencesAction()))
    ...
    def createHelpMenuManager(self):
        ...
        mng.addItem(poi.actions.ActionContributionItem(ui.actions.AboutAction()))
    ...
    def getMemento(self):
        ...
        global PLUGIN_ID
        wp = kernel.getPluginWorkspacePath(PLUGIN_ID)
        try:
