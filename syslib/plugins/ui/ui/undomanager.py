...
import poi.actions, ui.images as images
DEBUG = False
...
class UndoAction(poi.actions.Action):
    __module__ = __name__

    def __init__(self):
        poi.actions.Action.__init__(self, 'Undo\tCtrl+Z', 'Undo action', 'Undo Action')
...
class RedoAction(poi.actions.Action):
    __module__ = __name__

    def __init__(self):
        poi.actions.Action.__init__(self, 'Redo\tCtrl+Y', 'Redo action', 'Redo Action')
        addUndoManagerListener(self)
