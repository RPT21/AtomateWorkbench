...
import math, time, wx, threading, logging, executionengine.messages as messages, executionengine.images as images, executionengine, ui, ui.context, poi.utils, poi.utils.scrolledpanel, poi.utils.listctrl, panelview
...
TYPE2STATUS = {(executionengine.engine.TYPE_STARTING): 'Starting', (executionengine.engine.TYPE_ENDING): 'End', (executionengine.engine.TYPE_HOLD): 'Hold', (executionengine.engine.TYPE_ADVANCE): 'Advance', (executionengine.engine.TYPE_PAUSE): 'Pause', (executionengine.engine.TYPE_RESUME): 'Resume', (executionengine.engine.TYPE_ABORTING): 'Aborting', (executionengine.engine.TYPE_HARDWARE_INIT_ERROR): 'Error Initializing Hardware', (executionengine.engine.TYPE_HARDWARE_INIT_START): 'Initializing Hardware', (executionengine.engine.TYPE_HARDWARE_INIT_END): 'Finished Initializing'}

class GraphView(poi.utils.scrolledpanel.ScrolledPanel):
    __module__ = __name__

    def __init__(self, parent, perspective):
        poi.utils.scrolledpanel.ScrolledPanel.__init__(self, parent, style=wx.SIMPLE_BORDER)
...
class HistoryList(poi.utils.listctrl.ListCtrl):
    __module__ = __name__

    def __init__(self, parent):
        poi.utils.listctrl.ListCtrl.__init__(self, parent, -1, style=wx.LC_REPORT | wx.LC_NO_HEADER | wx.LC_HRULES)
...
class DetailedExecutionView(poi.utils.scrolledpanel.ScrolledPanel):
    __module__ = __name__
